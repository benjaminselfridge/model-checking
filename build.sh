cabal build
pandoc -s --metadata title="Model Checking in Haskell, Part 1: Transition Systems and Invariants" -f markdown+lhs -t gfm --markdown-headings=setext -o doc/ModelChecking1.md src/ModelChecking1.lhs
pandoc -s --metadata title="Model Checking in Haskell, Part 1: Transition Systems and Invariants" -f markdown+lhs -t html -o doc/ModelChecking1.html src/ModelChecking1.lhs
