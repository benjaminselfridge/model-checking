...
pandoc --metadata title="Model Checking in Haskell, Part 3: Parallelism" -s --toc --number-sections -o doc/ModelChecking3.md src/ModelChecking3.lhs
pandoc --metadata title="Model Checking in Haskell, Part 3: Parallelism" -s --toc --number-sections -o doc/ModelChecking3.html src/ModelChecking3.lhs
