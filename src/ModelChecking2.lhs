...
into a transition system. We'll then look at a few example programs, and show
how to use this conversion to check interesting invariants about the program's
state.
...
A *guard* is a function that tells us whether the program state satisfies a
